...
export class PaginaPrincipal {
    items = [
        {
            category: "Headphone",
            name: "Beat Studios 3 Wireless",
            price: 28.99,
            description: "Prime Black",
            img: "/img/product-20.jpg"
        },
        {
            category: "Smartphone",
            name: "Samgung Galaxy Note 10+",
            price: 199.99,
            description: "Sistema de Audio surround",
            img: "/img/product-74.jpg"
        },
        {
            category: "Musicphone",
            name: "Sony Ericsson",
            price: 18.99,
            description: "100% BPA - Free premium design",
